...
class EYE:
    ...
    def remove_2T(self):
        ...
        self.ref_t = self.ref_t[int(self.os) : -1 * int(self.os)]
        self.ref_v = self.ref_v[int(self.os) : -1 * int(self.os)]
        self.wfm_t = self.wfm_t[int(self.os) : -1 * int(self.os)]
        self.wfm_v = self.wfm_v[int(self.os) : -1 * int(self.os)]
